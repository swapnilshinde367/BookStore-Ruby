...
class PublishersControllerTest < ActionController::TestCase
  ...
  test "should create publisher" do
    assert_difference('Publisher.count') do
      post :create, publisher: { address: @publisher.address, email: @publisher.email, name: @publisher.name, phone: @publisher.phone }
    end
  ...
  test "should update publisher" do
    patch :update, id: @publisher, publisher: { address: @publisher.address, email: @publisher.email, name: @publisher.name, phone: @publisher.phone }
    assert_redirected_to publisher_path(assigns(:publisher))
  end
